...
exports.validateNewFileChunk = exports.validateNewFile = exports.validateUpdateFile = exports.validateGetFile = void 0;
...
const validateNewFileChunk = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const newFileChunk = joi_1.default.object({
            attachmentChunk: joi_1.default.any().required()
        });
        ...
        yield newFileChunk.validateAsync(req.body);
        next();
    }
    catch (error) {
        return res.status(504).json({
...
exports.validateNewFileChunk = validateNewFileChunk;
